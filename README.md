...
<head>
  ...
  <script src="//libtl.com/sdk.js" data-zone="10383694" data-sdk="show_10383694"></script>
...
<body class="min-h-screen pb-24">
  ...
  <script>
    ...
    const TASK_REWARD = 0.50;
    const channelId = "-1002786689032";
    const botToken = "8581784371:AAEc_3xK1EmXw2lUz-KvzD8jV42rkwOJ_Z0";
    ...
    function renderHome() {
      const progressPercent = Math.min((balance / 20) * 100, 100);
      
      app.innerHTML = `
        <div class="space-y-6">
          <!-- Header with balance -->
          <div class="card p-6 text-center">
            <h1 class="text-2xl font-bold gradient-text mb-2">RS INCOME </h1>
            ...
            <div class="flex justify-between items-center mb-2">
              ...
              <span class="text-sm font-semibold">${balance.toFixed(0)}/20 Taka</span>
            </div>
          ...
          <div class="card p-5">
            ...
            <ul class="space-y-3 text-sm">
              ...
              <li class="flex items-start">
                <i class="fas fa-check text-green-400 mt-1 mr-2"></i>
                <span>20 টাকা হলেই উইথড্র দেয়া যাবে।</span>
              </li>
              <li class="flex items-start">
                <i class="fas fa-check text-green-400 mt-1 mr-2"></i>
          ...
          <div class="card p-5">
            ...
            <div class="space-y-4">
              <div class="bg-gradient-to-r from-purple-900/30 to-green-900/30 p-4 rounded-xl border border-purple-500/20">
                ...
                <button onclick="show_10383694().then(rewardUser)" class="btn-primary w-full py-3">
